...
// SMTP Transporter - Environment variables kullan
const transporter = nodemailer.createTransport({
    host: process.env.SMTP_HOST || 'smtp.hostinger.com',
    port: parseInt(process.env.SMTP_PORT) || 465,
    secure: true,
    auth: {
        user: process.env.SMTP_USER || 'info@soloteknoloji.com.tr',
        ...
        <tr>
            <td style="padding: 40px 20px;">
                <table role="presentation" align="center" width="600" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto;">
                    ...
                    <!-- Logo Header -->
                    <tr>
                        <td style="background: #1a1a1a; padding: 25px 40px; border-radius: 12px 12px 0 0;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td>
                                        <img src="https://soloteknoloji.tr/assets/img/site_logo-Photoroom.png" alt="Solo Teknoloji" style="height: 45px; display: block;" />
                                    </td>
                                    <td align="right" style="vertical-align: middle;">
                                        <span style="color: #21BB9F; font-size: 11px; letter-spacing: 1.5px; text-transform: uppercase; font-weight: 600;">Barkod & Otomasyon</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <!-- Title Section -->
                    <tr>
                        <td style="${headerBg} padding: 24px 40px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="width: 50px; vertical-align: middle;">
                                        <div style="width: 42px; height: 42px; background: rgba(255,255,255,0.2); border-radius: 10px; text-align: center; line-height: 42px;">
                                            <span style="color: #fff; font-size: 18px;">${isDemo ? '&#xf518;' : '&#xf0e0;'}</span>
                                        </div>
                                    </td>
                                    <td style="vertical-align: middle; padding-left: 15px;">
                                        <h1 style="color: #ffffff; margin: 0; font-size: 20px; font-weight: 600; line-height: 1.3;">${title}</h1>
                                        <p style="color: rgba(255,255,255,0.85); margin: 4px 0 0 0; font-size: 13px;">${new Date().toLocaleDateString('tr-TR', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit' })}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
