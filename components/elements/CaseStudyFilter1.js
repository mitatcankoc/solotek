    ...
    useEffect(() => {
        ...
        const initIsotope = async () => {
            ...
            timeoutId = setTimeout(() => {
                ...
                if (gridElement && !isotope.current) {
                        ...
                        <div className="col-12">
                            <div className="mesonry-menu">
                                <ul id="grid-filter">
                                    ...
                                    <li className={activeBtn("lifestyle")} onClick={handleFilterKeyChange("lifestyle")}>
                                        Lifestyle
                                    </li>
                                    <li className={activeBtn("stories")} onClick={handleFilterKeyChange("stories")}>
                                        Stories
                                    </li>
                                    <li className={activeBtn("design")} onClick={handleFilterKeyChange("design")}>
                                        Design
                                    </li>
